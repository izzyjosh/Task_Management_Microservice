...
class TaskServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTask = channel.unary_unary(
                '/TaskService/GetTask',
                request_serializer=task__pb2.TaskGetRequest.SerializeToString,
                response_deserializer=task__pb2.TaskCreateResponse.FromString,
                _registered_method=True)
...
def add_TaskServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTask': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTask,
                    request_deserializer=task__pb2.TaskGetRequest.FromString,
                    response_serializer=task__pb2.TaskCreateResponse.SerializeToString,
            ),
    }
...
class TaskService(object):
    ...
    def GetTask(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/TaskService/GetTask',
            task__pb2.TaskGetRequest.SerializeToString,
            task__pb2.TaskCreateResponse.FromString,
            options,
            channel_credentials,
            insecure,
